...
export const list = [
  {
    ...
    multipleProps: [
      ...
      },
      {
        ...
        type: "livelike-alert",
        widgetProps: {
          image_url: "https://png.pngtree.com/svg/20161028/happy__949451.png"
        }
      },
      {
        name: null,
  ...
  {
    name: "Text Poll Widget",
    type: "livelike-text-poll",
    widgetProps: {
      question: "Test question",
      options: JSON.stringify([
        { id: "100", description: "Option One" },
        { id: "101", description: "Option Two" }
      ])
    },
    controlList: w.poll
  },
    ...
    widgetProps: {
      ...
      options: JSON.stringify([
        ...
        },
        {
          ...
          image_url: "http://simpleicon.com/wp-content/uploads/sad.png"
        }
      ])
    },
    controlList: w.poll
  ...
  {
    name: "Text Quiz",
    type: "livelike-text-quiz",
    widgetProps: {
      question: "Test question",
          widgetPayload: JSON.stringify({ timeout: "P0DT00H00M10S" }),

      choices: JSON.stringify([
        { id: "104", description: "Choice One" },
        { id: "105", description: "Choice Two" }
      ])
    },
    controlList: w.quiz
  },
...

  {
    name: "Predictions",
    type: null,
    controlList: w.prediction,
    multipleProps: [
      {
        name: "Text Prediction",
        type: "livelike-text-prediction",
        widgetProps: {
          question: "Test question",
      ...
      {
        name: "Text Prediction Follow Up",
        type: "livelike-text-prediction-follow-up",
        widgetProps: {
          question: "Test question",
          phase: 'show-results',
          // widgetPayload: { timeout: "P0DT00H00M10S" },
          options: JSON.stringify([
            {
              id: "110",
              description: "Choice One",
      ...
      },
      {
        ...
        type: "livelike-image-prediction",
        widgetProps: {
          question: "Test question",
          confirmation_message: "Test confirmation message",
          options: JSON.stringify([
            {
              ...
              description: "Choice One",
              image_url:
                "https://png.pngtree.com/svg/20161028/happy__949451.png"
            },
            {
              id: "109",
              description: "Choice Two",
      ...
      {
        name: "Image Prediction Follow Up",
        type: "livelike-image-prediction-follow-up",
        widgetProps: {
          question: "Test question",
          phase: 'show-results',
          // widgetPayload: { timeout: "P0DT00H00M10S" },
...

  {
    ...
    controlList: w.emojislider
  },

  {
    name: "Cheer Meter",
    type: "livelike-cheer-meter",
    widgetProps: {
      question: "MINIGAME - PICK A SIDE!",
      cheer_type: "tap",
      options: JSON.stringify([
        {
          id: "114",
    ...
    controlList: w.cheermeter
  },
  {
    name: "Rich Post",
    type: "livelike-rich-post",
    widgetProps: {
      content:
        "<p>This is a test</p>\n<p><strong>This is a test</strong><strong>&nbsp;</strong></p>\n<p><em>This is a test</em><em>&nbsp;</em></p>"
    },
    controlList: w.richpost
  },
  {
    name: "Social Embed",
    type: "livelike-social-embed",
    widgetProps: {
      comment: "Test social embed widget",
      items: JSON.stringify([
        ...
        },
        {
          ...
          oembed: {
            ...
            version: "1.0",
            title:
              "https://twitter.com/markdalgleish/status/1210105309844267008"
          }
        }
      ])
    },
    controlList: w.socialembed
  }
];
